...
public class ArtistAdapter extends BaseAdapter
{
    ...
    public ArtistAdapter(Context context, ArrayList<Artist> songsList)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        tv_SongName.setText(song.getArtistName());
        tv_SongArtist.setText("Albums : "+song.getArtistAlbumstotal());
